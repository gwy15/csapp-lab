...
00000000004010f4 <phase_6>:
  ...
  401100:	49 89 e5             	mov    %rsp,%r13                    # r13 = arr            ; ptr = arr;
  401103:	48 89 e6             	mov    %rsp,%rsi                    # rsi = arr            ; rsi = arr;
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>

  40110b:	49 89 e6             	mov    %rsp,%r14                    # r14 = arr            ; r14 = arr;
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                   # r12d = 0             ; for (i = 0; ; ) {
.outer:
  401114:	4c 89 ed             	mov    %r13,%rbp                    # rbp = r13                 
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax               # 
  40111b:	83 e8 01             	sub    $0x1,%eax                    # rax = r13[0] - 1          rax = ptr[0] - 1;
  40111e:	83 f8 05             	cmp    $0x5,%eax                    # if 0 < r13[0] <= 6:       assert 0 < ptr[0] <= 6
  401121:	76 05                	jbe    401128 <phase_6+0x34>        #    ok
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>        #
  401128:	41 83 c4 01          	add    $0x1,%r12d                   # r12d += 1                 i++;
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                   # if r12d == 6:             if i == 6:  break;
  401130:	74 21                	je     401153 <phase_6+0x5f>        #    goto break
  401132:	44 89 e3             	mov    %r12d,%ebx                   # rbx = r12d                for (j = i; j <= 5; j++) {
.loop:                                                              #                           
  401135:	48 63 c3             	movslq %ebx,%rax                    # rax = rbx                     assert arr[j] != *ptr;
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           # rax = arr[rbx]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)               # arr[rbx] != *rbp:
  40113e:	75 05                	jne    401145 <phase_6+0x51>        #   ok
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                    # rbx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                    # if rbx <= 5:
  40114b:	7e e8                	jle    401135 <phase_6+0x41>        #   goto loop               }

  40114d:	49 83 c5 04          	add    $0x4,%r13                    # else: r13 += 1            ptr ++;
  401151:	eb c1                	jmp    401114 <phase_6+0x20>        #                      ; }  
.break:                                                             #                [each 0 < <= 6 and != each other]
  
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              # rsi = rsp + 24 (arr[6]) (loop end)
  401158:	4c 89 f0             	mov    %r14,%rax                    # rax = r14 = arr
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    # rcx = 7
.loop:
  401160:	89 ca                	mov    %ecx,%edx                    # 
  401162:	2b 10                	sub    (%rax),%edx                  # rdx = rcx - *rax
  401164:	89 10                	mov    %edx,(%rax)                  # *rax = rdx              ;  *ptr = 7 - *ptr
  401166:	48 83 c0 04          	add    $0x4,%rax                    # rax += 4                ;  ptr++;
  40116a:	48 39 f0             	cmp    %rsi,%rax                    # if rsi != rax:
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>        #   goto loop
  
;           1~6，互补
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                    # rsi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>        # goto: do1
.find_linked_list_tail ; 找到链表的尾部
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx               # ptr = ptr->next         ;  rdx 是链表
  40117a:	83 c0 01             	add    $0x1,%eax                    # rax += 1                ;  rax ++
  40117d:	39 c8                	cmp    %ecx,%eax                    # if rcx != rax           ;  if 7 != rax:
  40117f:	75 f5                	jne    .loop 401176 <phase_6+0x82>  #     goto loop           ;    goto loop
  401181:	eb 05                	jmp    401188 <phase_6+0x94>        # loop end, on_linked_list_tail
.set_rdx_as_linked_list_head
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx               # set rdx to 0x6032d0
.on_linked_list_tail
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       # arr[32+2rsi] = rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                   # 24
  401195:	74 14                	je     .loop_end 4011ab <phase_6+0xb7>
.do1
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           # rcx = arr[rsi]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    # if arr[rsi] <= 1:
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>        #   goto set_rdx_as_linked_list_head
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                    # rax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx               # set rdx = linked_list_head
  4011a9:	eb cb                	jmp    .loop 401176 <phase_6+0x82>  # goto .find_linked_list_tail
.loop_end

  ; arr[32 ~ 32+8*6] : head ~ head->next..->next，根据 arr 确定
  ; 下面这段将 ptrs[6] 连接起来
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx              # rbx = ptrs[0]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax              # rax = &ptrs[1]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi              # rsi = &ptrs[6] (end)
  4011ba:	48 89 d9             	mov    %rbx,%rcx                    # rcx = rbx
.loop:
  4011bd:	48 8b 10             	mov    (%rax),%rdx                  # rdx = *rax
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)               # rcx[8] = rdx  ; rcx->next
  4011c4:	48 83 c0 08          	add    $0x8,%rax                    # rax += 8
  4011c8:	48 39 f0             	cmp    %rsi,%rax                    # if rax == rsi:
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>        # 
  4011cd:	48 89 d1             	mov    %rdx,%rcx                    # else:
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>        # rcx = rdx, goto loop
.loop_end
...
.loop2:
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax               # rax = rbx[8]  rbx->next
  4011e3:	8b 00                	mov    (%rax),%eax                  # rax = *rax
  4011e5:	39 03                	cmp    %eax,(%rbx)                  # if *rbx >= rax:
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>        #   ok
  ...
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>        # if ebp != 0:
                                                                    #   goto loop2
...
0000000000401204 <fun7>:                                          # rdi = root,  rsi = x
  401204:	48 83 ec 08          	sub    $0x8,%rsp
  401208:	48 85 ff             	test   %rdi,%rdi
  40120b:	74 2b                	je     .fail 401238 <fun7+0x34>   # assert rdi != 0
  40120d:	8b 17                	mov    (%rdi),%edx                # rdx = root->val;
  40120f:	39 f2                	cmp    %esi,%edx                  # val  ~  x
  401211:	7e 0d                	jle    401220 <fun7+0x1c>         # if val <= x: goto le
  
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi             # rdi = root->left
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    .return 40123d <fun7+0x39>
.le
  401220:	b8 00 00 00 00       	mov    $0x0,%eax                  # rax = 0
  401225:	39 f2                	cmp    %esi,%edx                  # if rsi == rdx:
  401227:	74 14                	je     .return 40123d <fun7+0x39> #   return 0
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi            # rdi = root->right
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>              # rax = fun7(rdi, rsi)
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax      # rax = rax + rax + 1
  401236:	eb 05                	jmp    .return 40123d <fun7+0x39>
.fail
  401238:	b8 ff ff ff ff       	mov    $0xffffffff,%eax           # return -1
...
0000000000401242 <secret_phase>:
  ...
  401248:	ba 0a 00 00 00       	mov    $0xa,%edx                      # rdx = 10; 十进制
  40124d:	be 00 00 00 00       	mov    $0x0,%esi                      # rsi = 0
  401252:	48 89 c7             	mov    %rax,%rdi                      # rdi = rax(read_line)
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>
  40125a:	48 89 c3             	mov    %rax,%rbx                      # rbx = parsed int x
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax                # rax = x - 1
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax                    # assert x-1 <= 1000
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>     # 0 < x <= 1001
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi                      # rsi = x
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi                 # rdi = root
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax                      # assert return == 2
...
00000000004015c4 <phase_defused>:
  ...
  4015c8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax              # canary
  4015cf:	00 00 
  4015d1:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
  4015d6:	31 c0                	xor    %eax,%eax                  # eax = 0
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings> ; 在 read_line 里面自增
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b>  # 如果不是第六关，跳过
  ...
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi               # esi = "%d %d %s"
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi               # edi = "<string from phase 4>"
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax
  401602:	75 31                	jne    401635 <phase_defused+0x71>
  401604:	be 22 26 40 00       	mov    $0x402622,%esi               # rsi = "DrEvil"
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi              # rdi = rsp + 12 = rcx
  ...
  401630:	e8 0d fc ff ff       	callq  401242 <secret_phase>        # 进入 secret_phase
.wrong
  401635:	bf 58 25 40 00       	mov    $0x402558,%edi             # 第六关通过的提示
